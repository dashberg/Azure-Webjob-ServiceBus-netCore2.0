 class Program
    {     
      ...
      {        
        ...
        // Serve up the dbcontext
        serviceCollection.AddDbContext<XXXContext>(sharedOptions => sharedOptions.UseSqlServer(defaultConnection));
        
        serviceCollection.AddScoped<IXXOrderService, XXXOrderSerivce>();       
